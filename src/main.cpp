...
// configuration step. It creates a namespace called `apt_project`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        apt_project::cmake::project_name,
        apt_project::cmake::project_version));// version string, acquired
